...
JsonRpcProvider.prototype.send = function LoggingAwareSend(this, method, params) {
  ...
  if (method === 'eth_call') {
    ...
    metadata = { method, params: { ...params, [0]: { ...params[0], data: methodHash } } }
  }

  return wrap(method, () => JsonRpcProviderSend.call(this, method, params), { squelch: true, metadata })
}
